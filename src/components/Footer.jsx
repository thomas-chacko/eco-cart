const Footer = () => {
  const footerLinks = {
    ...
    products: [
      ...
      { name: "Personal Care", href: "#personal" },
        ...
        <div className="grid lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Making sustainable shopping accessible to everyone. Join us in creating 
              a greener future, one purchase at a time.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="flex-1 px-6 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
              />
              <button className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-8 py-3 rounded-lg font-semibold hover:from-green-600 hover:to-emerald-600 transition-all duration-300 whitespace-nowrap cursor-pointer">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © 2024 EcoCart. All rights reserved. Made with 💚 for the planet.
            </div>
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <span>🌱 1 tree planted per order</span>
